...
-- CREATE DATABASE LINK TO MOVIES_CORE
-- Creare DB Link catre schema MOVIES
DROP DATABASE LINK movies_orcl_link;
--CREATE DATABASE LINK movies_orcl_link
--CONNECT TO MOVIES IDENTIFIED BY movies
...
SELECT * FROM MOVIES_CORE@movies_orcl_link WHERE ROWNUM <= 5;

SELECT * FROM MOVIES@movies_orcl_link 
WHERE ROWNUM <= 5;
